...
public class SimpleConsumerA {
	public static void main(String args[]) {
		SimpleConsumerA example = new SimpleConsumerA();
		long maxReads = 2;//Long.parseLong(args[0]);
		String topic = "acclog";// args[1];
		int partition = 1;// Integer.parseInt(args[2]);
		List<String> seeds = new ArrayList<String>();
		// seeds.add(args[3]);
		seeds.add("192.168.8.150");
		//seeds.add("192.168.8.146");
		//seeds.add("192.168.8.147");
